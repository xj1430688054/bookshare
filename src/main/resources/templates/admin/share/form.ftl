        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="frm" method="post" action="${ctx!}/admin/share/edit">
                        	<input type="hidden" id="id" name="id" value="${share.id}">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">图书图片：</label>
                                <div class="col-sm-8">
                                      <img alt="image" class="img-responsive" src="/${share.url}">
                                      
                                      <input type="hidden" id="url" name="url" value="${share.url}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="name" name="name" class="form-control" type="text" value="${share.name}" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="amount" name="amount" class="form-control" type="text" value="${share.amount}">
                                </div>
                            </div>
                            </#if>
						    ...
						    <div class="modal-dialog modal-lg" role="document">
						        <div class="modal-content">
						            ...
						            <div class="modal-body">
						                <form enctype="multipart/form-data" method="post" action="${ctx!}/admin/share/upload">
