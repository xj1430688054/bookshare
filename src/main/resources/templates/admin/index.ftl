            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                      ...
                      <@shiro.hasPermission name="system:share:index">
                            <li>
                               <a class="J_menuItem" href="${ctx!}/admin/share/index">图书分享管理</a>
                            </li>
                     		</@shiro.hasPermission>
                      ...
                      -->
                         ...
                         <@shiro.hasPermission name="system:sche:index">
                            <li>
                                <a class="J_menuItem" href="${ctx!}/admin/sche/index">举报信息管理</a>
                            </li>
                     </@shiro.hasPermission>
                        	...
                        	<#if sharetip != 0>
                                <li>
                                	<div class="text-center link-block">
                                    	<a class="J_menuItem" href="${ctx!}/admin/share/index">
                                        	<div>
                                            	<i class="J_menuItem"  class="fa fa-envelope fa-fw"></i> ${sharetip} 
